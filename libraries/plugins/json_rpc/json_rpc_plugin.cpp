...
FC_REFLECT( xgt::plugins::json_rpc::detail::json_rpc_error, (code)(message)(data) )
FC_REFLECT( xgt::plugins::json_rpc::detail::json_rpc_response, (jsonrpc)(result)(error)(id) )

FC_REFLECT( xgt::plugins::json_rpc::detail::get_signature_args, (method) )
