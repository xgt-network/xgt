...
struct api_wallet_object
{
   api_wallet_object( const wallet_object& a, const database& db ) :
      id( a.id ),
      name( a.name ),
      address_ripemd160( a.address_ripemd160 ),
      memo_key( a.memo_key ),
...
FC_REFLECT( xgt::plugins::database_api::api_wallet_object,
             (id)(name)(address_ripemd160)(recovery)(money)(social)(memo_key)(json_metadata)(social_json_metadata)(last_recovery_update)(last_account_update)
             (created)(mined)
