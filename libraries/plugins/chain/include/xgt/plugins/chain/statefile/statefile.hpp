...
struct xgt_version_info
{
   xgt_version_info( const database& db );
   xgt_version_info() {}
...
} } } } // namespace xgt::plugins::chain::statefile

FC_REFLECT( xgt::plugins::chain::statefile::xgt_version_info,
   (db_format_version)
   (network_type)
   (object_schemas)
   (config)
...
FC_REFLECT( xgt::plugins::chain::statefile::state_header,
   (version)
   (plugin_options)
   (sections)
   )

FC_REFLECT( xgt::plugins::chain::statefile::object_section,
   (object_type)
   (format)
   (object_count)
   (next_id)
...
FC_REFLECT_TYPENAME( xgt::plugins::chain::statefile::section_header )

FC_REFLECT( xgt::plugins::chain::statefile::section_footer,
   (hash)
   (begin_offset)
   (end_offset)
   )

FC_REFLECT_DERIVED( xgt::plugins::chain::statefile::state_footer,
   (xgt::plugins::chain::statefile::section_footer),
   (section_footers)
   (footer_begin)
   )
