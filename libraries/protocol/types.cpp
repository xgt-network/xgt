...
namespace xgt { namespace protocol {
    ...
    public_key_type::operator std::string() const
    {
       ...
       return XGT_ADDRESS_PREFIX + fc::to_base58( data.data(), data.size() );
    }
...
namespace fc
{
    ...
    {
        vo = xgt::protocol::public_key_type( var.as_string() );
    }
    ...
    {
       vo = xgt::protocol::extended_public_key_type( var.as_string() );
    }
    ...
    {
       vo = xgt::protocol::extended_private_key_type( var.as_string() );
    }
} // fc
