...
/*
 * This class represents the basic versioning scheme of the Xgt blockchain.
...
{
   class variant;
   void to_variant( const xgt::protocol::version& v, variant& var );
   void from_variant( const variant& var, xgt::protocol::version& v );

   void to_variant( const xgt::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, xgt::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( xgt::protocol::version, (v_num) )
FC_REFLECT_DERIVED( xgt::protocol::hardfork_version, (xgt::protocol::version), )

FC_REFLECT( xgt::protocol::hardfork_version_vote, (hf_version)(hf_time) )
