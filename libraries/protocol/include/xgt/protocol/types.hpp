...
namespace xgt {
   ...
   namespace protocol {
      ...
      typedef fixed_string<256>           address_ripemd160_type;
      ...
      typedef fc::ripemd160               contract_hash_type;
      ...
      #define XGT_INIT_PUBLIC_KEY (xgt::protocol::public_key_type(XGT_INIT_PUBLIC_KEY_STR))
...
namespace fc
{
    void to_variant( const xgt::protocol::public_key_type& var,  fc::variant& vo );
    void from_variant( const fc::variant& var,  xgt::protocol::public_key_type& vo );
    void to_variant( const xgt::protocol::extended_public_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, xgt::protocol::extended_public_key_type& vo );
    void to_variant( const xgt::protocol::extended_private_key_type& var, fc::variant& vo );
    void from_variant( const fc::variant& var, xgt::protocol::extended_private_key_type& vo );
}

FC_REFLECT( xgt::protocol::public_key_type, (key_data) )
FC_REFLECT( xgt::protocol::public_key_type::binary_key, (data)(check) )
FC_REFLECT( xgt::protocol::extended_public_key_type, (key_data) )
FC_REFLECT( xgt::protocol::extended_public_key_type::binary_key, (check)(data) )
FC_REFLECT( xgt::protocol::extended_private_key_type, (key_data) )
FC_REFLECT( xgt::protocol::extended_private_key_type::binary_key, (check)(data) )

FC_REFLECT_TYPENAME( xgt::protocol::share_type )

FC_REFLECT( xgt::void_t, )
