...
#define XGT_DECLARE_SCHEMA_CLASS( is_reflected, is_enum )       \
template< typename ObjectType >                                 \
struct schema_impl< ObjectType, is_reflected, is_enum >         \
   : public abstract_schema                                     \
{                                                               \
XGT_SCHEMA_TEMPLATE_CLASS_BODY( schema_impl )                   \
};

// Templated version of macro includes some method definitions
#define XGT_SCHEMA_TEMPLATE_CLASS_BODY( CLASSNAME )             \
...
#define XGT_SCHEMA_CLASS_BODY( CLASSNAME )                      \
...
#define XGT_SCHEMA_DEFINE_CLASS_METHODS( CLASSNAME )            \
...
XGT_DECLARE_SCHEMA_CLASS( false, false )
XGT_DECLARE_SCHEMA_CLASS(  true, false )
XGT_DECLARE_SCHEMA_CLASS(  true,  true )
