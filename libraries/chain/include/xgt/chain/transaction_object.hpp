...
FC_REFLECT( xgt::chain::transaction_object, (id)(packed_trx)(trx_id)(expiration) )
CHAINBASE_SET_INDEX_TYPE( xgt::chain::transaction_object, xgt::chain::transaction_index )

namespace helpers
{
   template <>
   class index_statistic_provider<xgt::chain::transaction_index>
   {
   public:
      typedef xgt::chain::transaction_index IndexType;
      typedef typename xgt::chain::transaction_object::t_packed_trx t_packed_trx;
