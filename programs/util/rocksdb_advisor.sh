...
while (( "$#" )); do
   case "$1" in
      ...
      -p|--stats-dump-period)
         ...
         ;;
      -h|--help)
         echo "Specify data directory with '--data-dir' (Default is ~/.xgtd)"
         echo "Specify xgtd directory with '--xgtd-dir' (Default is ../..)"
...
cd "$XGTD_DIR/libraries/vendor/rocksdb/tools/advisor"
