...
BOOST_AUTO_TEST_CASE( undo_object_disapear )
{
   try
   {
      ...
      */
      ...
      //XGT_REQUIRE_THROW( ao.modify( obj1, [&]( account_object& obj ){ obj.name = "name00"; obj.proxy = "proxy00"; } ), boost::exception );
...
BOOST_AUTO_TEST_CASE( undo_key_collision )
{
   try
   {
      ...
      ao.create( [&]( account_object& obj ){ obj.name = "name00"; } );
      XGT_REQUIRE_THROW( ao.create( [&]( account_object& obj ){ obj.name = "name00"; } ), boost::exception );
